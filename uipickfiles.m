...
%%%%%%%%%%%%%%%%Author Vicky%%%%%%%%%%%%%%%%%%
PIVlab_selectN1 = uicontrol('Position',[10 405+100 200 20],...
	'Style','checkbox',...
	'String','Auto update',...
	'Value',0,...
	'HorizontalAlignment','left',...
	'Callback',@PIVlab_select_CallbackN1,'tooltipstring','PIVlab will update with new ly received images');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
setappdata(hgui,'updater',0);    %Auto updater variable, default False
...
%%%%%%%%%%%%%%%%Author Vicky%%%%%%%%%%%%%%%%%%
    function PIVlab_select_CallbackN1(varargin)
        hgui=getappdata(0,'hgui');
        if get(PIVlab_selectN1,'Value')==1
            setappdata(hgui, 'updater', 1);
        else
            setappdata(hgui, 'updater', 0);
        end
